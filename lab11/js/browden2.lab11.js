...
function displayResults(data) {
  ...
  if (data.items) {
    data.items.forEach((item) => {
      ...
      resultDiv.innerHTML = `<p><strong>Title:</strong> ${title}</p><p><strong>Authors:</strong> ${authors.join(
        ', '
      )}</p>`; //newly created div HTML content changed to title and authors items
